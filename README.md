...
**Known Issues:** During Docker builds, you may encounter ESBuild version mismatches. If this occurs, clear `node_modules` and reinstall dependencies. See `DEPLOYMENT_NOTES.md` for detailed troubleshooting.
